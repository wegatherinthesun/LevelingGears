...
- Status: Mitigated (the manual override is a complete, real fix regardless of auto-detection's accuracy; the rewritten auto-detection method below is backed by two other real, working addons on this exact client, but still not confirmed live against this specific character -- see the 2026-07-14 update)
